...
export const LEGAL_BLOCKS: Record<LegalDoc, LegalBlock[]> = {
  ...
  privacy: [
    ...
    heading('rightsHeading'),
    paragraph('rightsBody'),
    paragraph('rightsComplaintBody'),
    heading('contactHeading'),
    paragraph('contactBody'),
    heading('changesHeading'),
    paragraph('changesBody'),
  ...
  impressum: [
    ...
    paragraph('operatorPhone'),
    paragraph('operatorTax'),
